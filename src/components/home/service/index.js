...
const Service = () => {
  ...
  const [topic1Color, setTopic1Color] = useState('topic-active');
  ...
  return (
    <div className="center-container">
      ...
      <div className="service-container">
        {showTopic1 && (
         <div className={`service-topic1 ${showTopic1 ? 'slide-in' : ''}`}>
              ...
              <div className="subservice">
                ...
                <div className="subservice-content">
                  ...
                  {selectedService === 'service2' && (
                    <div className={`main-subservice ${selectedService}-main`}>
                      <div className="subservicemain-content">
                        <h3>Service 2 - Nurture Customers </h3>
                        <h6>
                          Drive the desired action with click-worthy campaigns on
                          WhatsApp. Trigger uninterrupted notifications at scale
                          and boost ROI.
                  ...
                  {selectedService === 'service3' && (
                    <div className={`main-subservice ${selectedService}-main`}>
                      <div className="subservicemain-content">
                        <h3>Service 3 - Nurture Customers </h3>
                        <h6>
                          Drive the desired action with click-worthy campaigns on
                          WhatsApp. Trigger uninterrupted notifications at scale
                          and boost ROI.
                  ...
                  {selectedService === 'service4' && (
                    <div className={`main-subservice ${selectedService}-main`}>
                      <div className="subservicemain-content">
                        <h3>Service 4 - Nurture Customers </h3>
                        <h6>
                          Drive the desired action with click-worthy campaigns on
                          WhatsApp. Trigger uninterrupted notifications at scale
                          and boost ROI.
        ...
        {showTopic2 && (
         <div className={`service-topic2 ${showTopic2 ? 'slide-in' : ''}`}>
            <div className="service-image">
              <img src={Image} alt="Your Image" />
            </div  >
            <div className="subservice-container">
